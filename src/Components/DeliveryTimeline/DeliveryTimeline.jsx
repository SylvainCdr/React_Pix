...
return (
    <div data-aos="flip-down" className={styles['delivery-timeline']}>
        <div className={`${styles['timeline-item']} ${status === 'pending' ? styles['active'] : ''}`}>
        ...
        <div className={`${styles['timeline-item']} ${status === 'shipped' ? styles['active'] : ''}`}>
        ...
        <div className={`${styles['timeline-item']} ${status === 'delivered' ? styles['active'] : ''}`}>
