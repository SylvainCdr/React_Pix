    ...
    <div className="homepage-container">
      ...
      <div className="section-2">
        ...
        <p>
          ...
          place de solutions cyber. <br />Des certifications de conformités delivrées
          par nos consultants sur du compliance : Pixecurity couvre toute la
          haute chaine de valeur de la sureté. Pixecurity est le fournisseur de
